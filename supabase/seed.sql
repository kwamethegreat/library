...
-- ===================== Courses =====================
insert into public.courses (id, track_id, slug, title, description, level, access_level, published, sort_order)
values
  ('aaaaaaaa-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'intro-to-react', 'Intro to React', 'React fundamentals from scratch.', 'beginner', 'free', true, 1),
  ('aaaaaaaa-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'advanced-react', 'Advanced React', 'Patterns, performance, and architecture.', 'advanced', 'paid', true, 2),
  ('aaaaaaaa-0000-0000-0000-000000000003', '22222222-2222-2222-2222-222222222222', 'intro-to-postgres', 'Intro to Postgres', 'Relational databases and SQL.', 'beginner', 'free', true, 1)
on conflict (id) do nothing;
